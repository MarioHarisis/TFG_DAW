...
export class HomeComponent {
  ...
  listaEspacios: Espacio[] = [
    ...
    new Espacio("Golf Club", "A fantastic natural football pitch", 22, "https://images.unsplash.com/photo-1505413461823-c5628c330608?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"),
  ];
}